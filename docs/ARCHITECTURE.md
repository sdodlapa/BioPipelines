...
│  │                 │  │                 │  │                             │  │
│  │  For: GUI users │  │ For: Scripting  │  │  For: Developers            │  │
│  └────────┬────────┘  └────────┬────────┘  └──────────────┬──────────────┘  │
│           │                    │                          │                 │
│           └────────────────────┼──────────────────────────┘                 │
│                                │                                            │
...
**Key Insight**: The BioPipelines Facade (highlighted with double borders) is the **common layer** that all three user interfaces use. It's not a separate entry point—it's the unified internal API that ensures consistency across Web UI, CLI, and Python API.
